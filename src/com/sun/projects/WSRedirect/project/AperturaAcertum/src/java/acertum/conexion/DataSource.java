...
//        ds.setUsername("DIGBB");
//        ds.setPassword("DIGBB");
//        ds.setUrl("jdbc:oracle:thin:@10.51.230.96:1521/DIGBDRHDES");
//        ds.setUrl("jdbc:oracle:thin:@10.51.230.96:1521:xe");
        ds.setDriverClassName(Propiedades.getProp("driver"));
        ds.setUsername(Propiedades.getProp("user"));//MIKE
        ds.setPassword(Propiedades.getProp("password"));//DIGBB

package acertum.aclaraciones.dto;

import javax.xml.bind.annotation.XmlRootElement;

@XmlRootElement
public class AclaracionesDto {

    private String idFolioAclaracion;
    private String idCteAclaracion;
    private int idPais;
    private int idCanal;
...
//	}
    ...
    /**
     * Concatena y regresa los campos pais canal sucursal folio, para dar el cliente unico
     * @return el id de cliente unico
     */
    ...
    /**
     * @return the idFolioAclaracion
     */
    public String getIdFolioAclaracion() {
        return idFolioAclaracion;
    }

    /**
     * @param idFolioAclaracion the idFolioAclaracion to set
     */
    public void setIdFolioAclaracion(String idFolioAclaracion) {
        this.idFolioAclaracion = idFolioAclaracion;
    }

    /**
     * @return the idCteAclaracion
     */
    public String getIdCteAclaracion() {
        return idCteAclaracion;
    }

    /**
     * @param idCteAclaracion the idCteAclaracion to set
     */
    public void setIdCteAclaracion(String idCteAclaracion) {
        this.idCteAclaracion = idCteAclaracion;
    }
